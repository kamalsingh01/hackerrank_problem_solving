...
All of the values are in the range [0...3] , so create an array of zeros, reasult = [0,0,0,0]. The results of each iteration follow:
...
arr = [1,1,3,2,1]
result = [0]*100     # because of this constraint 0 <= arr[i] < 100
for i in arr:
    result[i] = result[i]+1
print(result)